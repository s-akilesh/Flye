...
export const ContactChips = ({ className = '' }) => {
  ...
  return (
    <div className={`contact-chips-container ${className}`}>
      <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="contact-chip whatsapp">
      ...
      <a href={`tel:${settings.contactPhone}`} className="contact-chip">
      ...
      <a href={`mailto:${settings.contactEmail}`} className="contact-chip">
