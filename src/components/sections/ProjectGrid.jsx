        ...
        return (
          ...
          >
            ...
            <div className="card-spec-row">
              <span className={`spec-node diff-${diff}`}>● {difficultyLabel}</span>
              <span className="spec-node">⏱ {proj.buildTime}</span>
              <span className="spec-node" style={{ color: 'var(--text-dim)' }}>📁 {proj.projectLevel}</span>
            </div>
