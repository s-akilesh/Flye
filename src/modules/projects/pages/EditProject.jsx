              ...
              >
                {thumbnailPreview ? (
                  ...
                  <>
                    ...
                    <div style={{ fontSize: '13px', color: 'var(--txt-muted)', marginBottom: '4px' }}>Click to upload a new thumbnail</div>
                    <div style={{ fontSize: '11px', color: 'var(--txt-muted)' }}>Any image format · Max 5MB</div>
                  </>
                )}
                {thumbnailPreview && (
