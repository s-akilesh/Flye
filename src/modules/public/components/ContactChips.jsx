...
export const ContactChips = ({ className = '' }) => {
  const { settings } = useSettings();

  return (
    <div className={`contact-chips-container ${className}`}>
      <a
        href={`https://wa.me/${settings.whatsappNumber}`}
        target="_blank"
        rel="noopener noreferrer"
        onClick={() => eventTracker.trackWhatsAppClick('support')}
      ...
      <a
        ...
        onClick={() => eventTracker.trackPhoneCall(settings.contactPhone)}
      ...
      <a
        ...
        onClick={() => eventTracker.trackEmailClick(settings.contactEmail)}
        className="contact-chip"
      >
