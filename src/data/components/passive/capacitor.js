  ...
  "variants": [
    {
      ...
      "workingSteps": [
        {
          "title": "Charge",
          "desc": "When connected to a power source, electrons flow and gather on the negative plate, creating an electric field across the insulator."
        },
        {
          "title": "Store Energy",
          "desc": "The insulator stops electrons from crossing, holding them in place. The energy is stored in the electric field between plates."
        },
        {
          "title": "Discharge",
          "desc": "When the power source is removed and a path is provided, the stored electrons rush out to power the load instantly."
        }
      ],
      "applications": [
        {
      ...
      "relatedConnections": [
        {
          "from": "Resistor",
          "to": "Capacitor",
          "desc": "Controls how fast the capacitor charges"
        },
        {
          "from": "Capacitor",
          "to": "LED",
          "desc": "Supplies smooth energy to prevent flickering"
        }
      ],
      "miniProject": {
      ...
      "learningObjectives": [
        "Understand electric charge storage and capacitance units.",
        "Differentiate between polarized (electrolytic) and non-polarized capacitors.",
        "Use capacitors for supply ripple filtering and timing."
      ],
      "learningOutcome": "After completing this lesson, students will be able to select, calculate, and implement capacitors to smooth power inputs.",
      "workingPrinciple": {
        "whatIsIt": "An Electrolytic Capacitor is a polarized passive component that stores electrical energy in an electrostatic field.",
        "whyNeeded": "It filters voltage fluctuations (noise) in power lines and stores energy for quick release.",
        "howItWorks": "Voltage builds charge vectors on two metal foils separated by a thin oxide layer. Polarized chemicals facilitate high capacitance."
      },
      "pinout": {
        "pins": [
          {
            ...
            "direction": "Input",
            "voltage": "V_positive",
            "description": "Longer leg lead. Connect to positive voltage node."
          },
          {
            "name": "Cathode (-)",
            "direction": "Output",
            "voltage": "GND",
            "description": "Shorter leg lead, marked with stripe. Connect to ground node."
          }
        ]
      },
      "circuitSymbol": {
        "svg": "<svg viewBox=\"0 0 40 60\" width=\"40\" height=\"60\" stroke=\"currentColor\" stroke-width=\"2.5\" fill=\"none\"><line x1=\"20\" y1=\"5\" x2=\"20\" y2=\"25\" /><line x1=\"10\" y1=\"25\" x2=\"30\" y2=\"25\" /><path d=\"M10,35 C15,32 25,32 30,35\" /><line x1=\"20\" y1=\"34\" x2=\"20\" y2=\"55\" /><text x=\"3\" y=\"20\" font-size=\"14\" font-weight=\"bold\" fill=\"currentColor\">+</text></svg>",
        "meaning": "One straight line (anode) and one curved line (cathode) representing charge storage boundaries.",
        "orientation": "Strictly polarized. Reverse voltage can destroy the component.",
        "usage": "Always connect Cathode (marked with stripe) directly to ground."
      },
      "internalStructure": {
        "svg": "<svg viewBox=\"0 0 100 50\" width=\"100\" height=\"50\"><rect x=\"30\" y=\"10\" width=\"40\" height=\"30\" rx=\"4\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.5\" /></svg>",
        "description": "Consists of two aluminum foil plates coated with liquid electrolyte, separated by insulating paper, and rolled inside a can."
      },
      "specifications": [
        {
          "label": "Capacitance Range",
          "value": "1µF to 10,000µF"
        },
        {
      ...
      "advantages": [
        "Very high capacitance in a compact size",
        "Low cost per microfarad",
        "Excellent for bulk smoothing applications"
      ],
      "limitations": [
        "Short operational lifetime compared to ceramic caps",
        "High leakage currents",
        "Explosion risk under reverse polarity or overvoltage"
      ],
      "engineeringTips": [
        "Select a capacitor with a voltage rating at least 50% higher than the peak circuit voltage to guarantee safety.",
        "Look for the grey or white stripe on the side of the body: that stripe points to the negative Cathode lead."
      ],
      "safetyNotes": [
        "Connecting an electrolytic capacitor backward will cause gas buildup, triggering a loud pop and chemical venting!"
      ],
      "engineeringChecklist": [
        "Verify positive and negative lead directions match the schematic.",
        "Check that operating voltage is below the printed limit."
      ],
      "datasheet": "Radial Electrolytic Capacitor: Capacitance 100uF, Voltage Rating 25V, Tolerance ±20%, Temp Range -40°C to 105°C.",
      "downloads": [
        {
          "type": "Datasheet PDF",
          "filename": "radial_electrolytic_capacitor.pdf",
          "size": "200 KB"
        }
      ],
      "arduinoExamples": [
        {
          "title": "RC Timing Delay Read",
          "code": "\nvoid setup() {\n  pinMode(2, INPUT); // RC trigger input\n  Serial.begin(9600);\n}\nvoid loop() {\n  int val = digitalRead(2);\n  Serial.println(val); // Observe discharge curve\n  delay(100);\n}\n        "
        }
      ],
      "wiringExamples": [
        {
          "description": "Connect capacitor across the 5V and GND rail on a breadboard to smooth supply ripples.",
          "connections": [
            {
              "from": "Breadboard 5V Rail",
              "to": "Capacitor Anode (+)"
            },
            {
              "from": "Breadboard GND Rail",
              "to": "Capacitor Cathode (-)"
            }
          ]
        }
      ],
      "simulations": [
        {
          "name": "RC Charging Curve Lab",
          "url": "https://example.com/capacitor-sim"
        }
      ],
      "relatedLessons": [
        "what-is-electricity",
      ...
      "comparisonComponents": [
        {
          "name": "Ceramic vs Electrolytic Capacitor",
          "pros": [
            "Much higher capacitance density"
          ],
          "cons": [
            "Polarized, high leakage, wears out"
          ],
          "idealFor": "Power supply noise filtering"
        }
      ],
      "quiz": [
        {
          "question": "What is the primary unit of capacitance?",
          "options": [
            "Ohm",
            "Farad",
            "Henry",
          ...
          "answer": 1,
          "explanation": "Capacitance is measured in Farads (commonly microfarads uF)."
        }
      ],
      "xpReward": 50,
      "aiSuggestedQuestions": [
        "What happens if I wire an electrolytic capacitor backward?",
        "How does a decoupling capacitor filter out electrical noise?"
      ],
      "buildChallenge": {
        "objective": "Build a charge-discharge visual timing circuit (fade delay) using a capacitor.",
        "estimatedTime": "15 min",
        "difficulty": "Beginner",
        "requiredComponents": [
          {
        ...
        "wiringSteps": [
          {
            "stepNum": 1,
            "text": "Insert the 100µF Capacitor. Connect Cathode (stripe) to GND. Connect Anode to row 10.",
            "expectedResult": "Capacitor is polarized correctly."
          },
          {
            "stepNum": 2,
            "text": "Connect the 10kΩ Resistor from battery positive (+) to Capacitor Anode row 10.",
            "expectedResult": "Charging path established."
          },
          {
            "stepNum": 3,
            "text": "Connect the 220Ω Resistor from Capacitor Anode row 10 to LED Anode.",
            "expectedResult": "Discharging current limits."
          },
          {
            "stepNum": 4,
            "text": "Connect LED Cathode to GND.",
            "expectedResult": "Loop return complete."
          }
        ],
        "expectedOutput": "When battery is connected, the capacitor charges and keeps the LED glowing for a few seconds even after battery positive is unplugged.",
        "troubleshooting": [
          {
            "symptom": "LED does not fade out slowly",
            "causes": [
              "Capacitor wired backward",
              "Resistor values swapped"
            ],
            "fixSteps": [
              "Verify capacitor polarity stripe.",
              "Check that 10k resistor is in the charge path."
            ]
          }
        ],
        "experiments": [
          {
            ...
            "description": "Replace the 100uF capacitor with a 470uF capacitor and observe the LED glow time quadruple."
          }
        ],
        "verificationChecklist": [
          "Polarity stripe on capacitor points to GND",
          "Fading behavior visible when power is disconnected"
        ],
        "reflectionQuestions": [
          "Why does the LED stay lit after the battery is disconnected?",
          "How did changing the capacitance value affect the fade duration?"
        ],
        "relatedProjects": [
          "LED Fade Delay Timer",
          "Power Regulator Smoothing filter"
        ],
        "xpReward": 100,
        "badge": "Temporal Circuits Badge"
      }
    },
    {
      ...
      "parts": [
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "The orange plastic coating on the outside."
            },
            {
              "question": "What is its job?",
              "answer": "It protects the ceramic disk inside from dust, dirt, and water."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              ...
              "answer": "Thin silver coatings on the ceramic disk."
            },
            {
              "question": "What is their job?",
              "answer": "They act as the two metal plates that hold the electrical charge."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "A tiny slice of ceramic placed between the silver layers."
            },
            {
              "question": "What is its job?",
              "answer": "It acts as an insulator to block direct current while allowing signals to pass."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Two equal-length copper legs."
            },
            {
              "question": "Is polarity important?",
              "answer": "No! You can connect these legs in any direction. There is no positive or negative."
            }
          ]
        }
      ],
      ...
      "applications": [
        {
          "id": "television",
          "role": "Signal Filter",
          "desc": "Filters high-speed signals. It removes electrical noise from TV signals for a clear picture."
        },
        {
          "id": "arduino",
          "role": "Noise Cleaner",
          "desc": "Cleans up electrical noise. Placed near microchips to filter out minor voltage ripples."
        },
        {
          "id": "amplifier",
          "role": "Treble filter",
          "desc": "Tone helper. Allows high-pitch sounds to pass to speakers while blocking bass."
        },
        {
          "id": "phone-charger",
          "role": "EMI filter",
          "desc": "Radio noise blocker. Prevents the charger from interfering with radio signals."
        }
      ],
      "quickSummary": [
      ...
      "parts": [
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "The outer casing, usually made of wax-coated paper or plastic."
            },
            {
              "question": "What is its job?",
              "answer": "It seals the inside layers and keeps out moisture, which ruins paper."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Two sheets of aluminum foil rolled into a tube."
            },
            {
              "question": "What is their job?",
              "answer": "They carry the positive and negative electrical charges."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "Kraft paper soaked in oil or wax."
            },
            {
              "question": "Why oil?",
              "answer": "Dry paper is a poor insulator. Soaking it in oil makes it much better at blocking electricity."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Metal legs coming out from the opposite ends of the cylinder."
            },
            {
              "question": "How do you connect them?",
              "answer": "Since it is non-polarized, you can solder them either way."
            }
          ]
        }
      ],
      ...
      "applications": [
        {
          "id": "amplifier",
          "role": "Vintage Tuning",
          "desc": "Signal coupling. Passes audio signals between amplifier stages in old radios."
        },
        {
          "id": "television",
          "role": "Mains Filter",
          "desc": "Absorbs high-voltage spikes in industrial machines and old tube equipment."
        },
        {
          "id": "arduino",
          "role": "Motor Starter",
          "desc": "Helps kick-start old electric fan motors."
        }
      ],
      "quickSummary": [
      ...
      "parts": [
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "The outer box shell, usually green, red, or yellow."
            },
            {
              "question": "What is its job?",
              "answer": "It keeps the plastic layers safe from humidity and physical impacts."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "An ultra-thin roll of polyester plastic film."
            },
            {
              "question": "What is its job?",
              "answer": "It is the insulator that blocks electricity from passing directly."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Aluminum layers sprayed directly onto the plastic film."
            },
            {
              "question": "What is their job?",
              "answer": "They act as the electrode plates that store electrical charge."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Two wires extending from the metal layers."
            },
            {
              "question": "Is direction important?",
              "answer": "No! Solder it in any direction you like."
            }
          ]
        }
      ],
      ...
      "applications": [
        {
          "id": "amplifier",
          "role": "Tone Control",
          "desc": "Tone shaper. Adjusts bass and treble output in speaker circuits."
        },
        {
          "id": "phone-charger",
          "role": "AC filter",
          "desc": "AC filter. Blocks high-voltage spikes on electrical power lines."
        },
        {
          "id": "television",
          "role": "Sound Filter",
          "desc": "Audio coupling. Passes clean audio signals while blocking raw DC voltages."
        }
      ],
      "quickSummary": [
    ...
    },
    {
      ...
      "specs": [
        ...
        {
          "label": "Polarity",
          "value": "Polarized (Has marked + side)"
        }
      ],
      "parts": [
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "The yellow/orange hard epoxy droplet coating."
            },
            {
              "question": "Why this shape?",
              "answer": "It is dipped in liquid epoxy resin to create a tiny, robust protective shell."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "A spongy block of sintered tantalum metal powder."
            },
            {
              "question": "Why is it spongy?",
              "answer": "The spongy texture creates a massive surface area in a tiny space, allowing high capacitance."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "A microscopic layer of rust grown on the tantalum pellet."
            },
            {
              "question": "Why is it special?",
              "answer": "It is incredibly thin, allowing charges to sit very close together."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "How is polarity marked?",
              "answer": "Unlike electrolytic capacitors, the plus (+) side is explicitly marked with a stripe or plus symbol."
            },
            {
              "question": "Is polarity critical?",
              "answer": "Yes! Tantalum is highly sensitive to reverse voltage."
            }
          ]
        }
      ],
      ...
      "applications": [
        {
          "id": "motherboard",
          "role": "Laptop RAM buffer",
          "desc": "Compact buffer. Stabilizes voltage next to small laptop RAM sticks."
        },
        {
          "id": "phone-charger",
          "role": "Phone Filter",
          "desc": "Voltage regulator. Smooths power inside smartphones."
        },
        {
          "id": "arduino",
          "role": "Hearing Aid Filter",
          "desc": "Micro filter. Fits inside tiny hearing aid electronics."
        }
      ],
      "quickSummary": [
      ...
      "parts": [
        {
          ...
          "cards": [
            {
              "question": "What is it?",
              "answer": "The metal rod or knob at the top."
            },
            {
              "question": "What is its job?",
              "answer": "You turn it to rotate the metal plates, changing how much charge is stored."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Metal plates connected to the shaft."
            },
            {
              "question": "Why do they move?",
              "answer": "Rotating them changes how much they overlap with the stationary plates below."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              "question": "What are they?",
              "answer": "Fixed metal plates that do not move."
            },
            {
              "question": "What is their job?",
              "answer": "They act as the opposite electrical plate. The air gaps between these and the rotor plates store energy."
            }
          ]
        },
        {
          ...
          "cards": [
            {
              ...
              "answer": "Solder tabs at the base."
            },
            {
              "question": "How do you wire them?",
              "answer": "Connect one to the rotor contact and one to the stator contact."
            }
          ]
        }
      ],
      ...
      "applications": [
        {
          "id": "television",
          "role": "Radio Tuner",
          "desc": "Frequency tuner. Turn the dial to select different radio stations."
        },
        {
          "id": "amplifier",
          "role": "Antenna Matcher",
          "desc": "Signal tuner. Tunes wireless antenna circuits for best reception."
        },
        {
          "id": "phone-charger",
          "role": "Frequency adjust",
          "desc": "Sets the operating speed of timing oscillator circuits."
        }
      ],
      "quickSummary": [
